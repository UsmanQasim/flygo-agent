          ...
          <div className="col-xl-5">
            <div className="about-text">
              <div>
                ...
                <p>
                  Welcome to FlyGo, where booking flights is a breeze. Discover
                  seamless travel experiences with our user-friendly platform.
                  Book your flights with ease and explore the world with
                  confidence. FlyGo makes your travel dreams a reality.
                </p>
                <img
