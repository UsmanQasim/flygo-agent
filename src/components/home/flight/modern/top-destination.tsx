...
const TopDestination: FC = () => {
  return (
    <section className="pt-0 flight-detail  zig-zag-effect">
      <BackgroundDiv titleClass="section-b-space section-t-space" displayClass="none" img={"/assets/images/bluebg.jpg"} divImg="/assets/images/bluebg.jpg" imgWidth={0} imgHeight={0}>
